...
PanelWindow {
    ...
    // WiFi scan — now also checks saved connections so we know which SSIDs
    // already have a stored profile and can connect without a password prompt.
    Process {
        id: wifiScanner
        command: ["bash", "-c",
    ...
    Rectangle {
        ...
        Rectangle {
            anchors.fill: parent
            color: Theme.background; border.color: Theme.primary
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Text { anchors.centerIn: parent; text: "󰑓"; color: Theme.primary; font.pixelSize: 14
                ...
                Rectangle {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            // Expand only for networks that are NOT saved and need a password
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    color: Theme.primary; opacity: modelData.active ? 1.0 : 0.6
                                    font.pixelSize: 16
                                }
                                ...
                                Column {
                                    ...
                                    Text {
                                        text: modelData.ssid; color: Theme.primary
                                        font.pixelSize: 12
                                    ...
                                    Text {
                                        text: modelData.active   ? "Connected"
                                            ...
                                            : (modelData.security && modelData.security !== "--") ? "󰌆  " + modelData.security
                                            : "Open"
                                        color: Theme.primary; opacity: modelData.active ? 0.8 : 0.4
                                        font.pixelSize: 9
                                    }
                                }
                                ...
                                Row {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                if (modelData.active) {
                                                    ...
                                                    // ── FIX: saved profile → connect directly, no password needed ──
                                                    popup.wifiConnecting = modelData.ssid
                                                    wifiConnector.command = ["nmcli", "con", "up", modelData.ssid]
                                                    ...
                                                    // Secured, not saved → show password prompt
                                    ...
                                    Text {
                                        visible: popup.wifiConnecting === modelData.ssid
                                        text: "…"; color: Theme.primary; opacity: 0.5; font.pixelSize: 12
                                    }
                            ...
                            // Password row (only for unsaved secured networks)
                            ColumnLayout {
                                anchors.left: parent.left; anchors.right: parent.right
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { text: "󰅖"; color: Theme.primary; opacity: 0.4; font.pixelSize: 12
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Column {
                                    ...
                                    Text { text: modelData.name || modelData.mac; color: Theme.primary; font.pixelSize: 12
                                           font.weight: modelData.connected ? Font.Bold : Font.Normal
                                           elide: Text.ElideRight; width: parent.width }
                                    Text { text: modelData.connected ? "Connected" : (modelData.paired ? "Paired" : "")
            ...
            ColumnLayout {
                    ...
                    component CircleGauge: Item {
                        ...
                        Canvas {
                            ...
                            onPaint: {
                                ...
                                var startAngle = Math.PI * 0.75, sweepAngle = Math.PI * 1.5
                                ctx.beginPath(); ctx.arc(cx, cy, r, startAngle, startAngle + sweepAngle, false)
                                ctx.strokeStyle = gauge.trackColor; ctx.lineWidth = 8; ctx.lineCap = "round"; ctx.stroke()
                                if (animValue > 0) {
                                    ctx.beginPath(); ctx.arc(cx, cy, r, startAngle, startAngle + sweepAngle * animValue, false)
                                    ctx.strokeStyle = gauge.fillColor; ctx.lineWidth = 8; ctx.lineCap = "round"; ctx.stroke()
                                }
                                if (animValue > 0.02) {
                                    var tipAngle = startAngle + sweepAngle * animValue
                                    var tx = cx + r * Math.cos(tipAngle), ty = cy + r * Math.sin(tipAngle)
                                    ctx.beginPath(); ctx.arc(tx, ty, 4, 0, Math.PI*2)
                                    ctx.fillStyle = gauge.fillColor; ctx.fill()
                                }
                            }
                            ...
                            Column {
                                ...
                                Text { anchors.horizontalCenter: parent.horizontalCenter; text: Math.round(gauge.value * 100) + "%"
                                       color: gauge.fillColor; font.pixelSize: 13; font.weight: Font.Black }
                            }
                        }

                        Text {
                            anchors.horizontalCenter: parent.horizontalCenter; anchors.bottom: parent.bottom
                            text: gauge.label; color: Theme.primary; opacity: 0.55; font.pixelSize: 11; font.weight: Font.Medium
                        }
                    }
                    ...
                    Repeater {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Item { Layout.fillWidth: true }
                                Text { text: Math.round(modelData.value * 100) + "%"
                            ...
                            Rectangle {
                                ...
                                color: Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.1)
                                Rectangle {
                                    width: parent.width * modelData.value; height: parent.height; radius: 3
                                    color: modelData.value > 0.85 ? "#e06c75" : Theme.primary; opacity: 0.85
                ...
                Rectangle {
                    ...
                    Text { anchors.centerIn: parent; text: "󰓅  Open System Monitor"
